...
Nombre del producto: MOBIL DTE 10 EXCEL 46
Fecha de Revisión: 25 Jun 2022

Número de revisión: 2.00
Página 1 de 11
...
De acuerdo a la fecha de revisión arriba indicada, esta SDS cumple con las regulaciones en Chile.

**PRODUCTO**

**Nombre del producto:** **MOBIL DTE 10 EXCEL 46**
**Descripción del producto:** Base lubricante y Aditivos
**Código del producto:** 201560103640, 622639-60
**Usos Recomendados:** Fluido hidráulico
...
**IDENTIFICACIÓN DE PELIGRO SEGÚN NCh2190:** No peligroso
...
**PELIGROS FÍSICOS / QUÍMICOS AGUDOS Y CRÓNICOS**
...
**PELIGROS AL MEDIO AMBIENTE AGUDOS Y CRÓNICOS**
...
_____________________________________________________________________________________________________________________ **NFPA (NCh1411/4) ID de** Salud: 0 Inflamabilidad: 1 Reactividad: 0
**peligro:**
...
Clasificaciones específicas, Peligros o Pictogramas adicionales: No es aplicable
...
|Nombre|CAS#|Concentración*|Códigos SGA de<br>Peligro|
|---|---|---|---|
|2,6-DI TER- BUTILFENOL|128-39-2 <br>|0.1 - < 0.25% <br>|H315, H400(M factor 1),<br>H410(M factor 1) <br>|
|ACEITES LUBRICANTES (PETRÓLEO), BASADOS EN<br>ACEITE NEUTRO TRATADO CON HIDRÓGENO|72623-86-0 <br>|1 - < 5% <br>|H304 <br>|
|DESTILADO PARAFÍNICO PESADO FUERTEMENTE<br>HIDROTRATADO|64742-54-7|20 - < 30%|H304|
...
_____________________________________________________________________________________________________________________ Enjuague completamente con agua. Si se presenta irritación, obtenga asistencia médica.

**INGESTIÓN**

Normalmente no se requieren primeros auxilios. Si ocurre algún malestar busque atención médica.

**LOS SÍNTOMAS Y EFECTOS AGUDOS Y RETARDADOS MAS IMPORTANTES**

Necrosis local evidenciada por la aparición retardada de dolor y daños en los tejidos unas pocas horas
...
**Peligros de incendio poco usuales:** Las neblinas a presión pueden formar una mezcla inflamable.

**Productos de combustión peligrosos:** Aldehídos, Productos de combustión incompleta, Óxidos de
carbón, Humo, Óxidos de azufre
La exposición a los productos de combustión puede generar efectos tóxicos adversos y/o irritación.
...
_____________________________________________________________________________________________________________________ de Protección Personal. Medidas de protección adicional pueden ser necesarias dependiendo de las
...
**MANIPULACIÓN, MEDIDAS OPERACIONALES Y TÉCNICAS APLICABLES**
...
una chispa eléctrica puede encender los vapores de líquidos inflamables o residuos que puedan estar
...
Rayos y Corrientes Parásitas) o National Fire Protection Agency 77 (práctica recomendada en la electricidad
estática) o CENELEC CLC / TR 50404 (Electrostática - Código de conducta para evitar los riesgos debidos a la
...
**Otras medidas de precaución apropiadas: No es aplicable**
...
|Nombre de la sustancia|Forma|Límite / Norma|Col4|Col5|Nota|Fuente|
|---|---|---|---|---|---|---|
|ACEITES LUBRICANTES<br>(PETRÓLEO), BASADOS EN ACEITE<br>NEUTRO TRATADO CON<br>HIDRÓGENO|Fracción<br>inhalable. <br>|TWA <br>|5 mg/m3 <br>||N/A <br>|ACGIH <br>|
|DESTILADO PARAFÍNICO PESADO<br>FUERTEMENTE HIDROTRATADO|Neblina.|TWA <br>|5 mg/m3 <br>||N/A <br>|OSHA Z1 <br>|
|DESTILADO PARAFÍNICO PESADO<br>FUERTEMENTE HIDROTRATADO|Fracción<br>inhalable.|TWA|5 mg/m3||N/A|ACGIH|

**Límites y estándares de exposición para los materiales que pueden formarse durante el manejo de este**
**producto:** Cuando se pueda presentar niebla/aerosoles se recomienda lo siguiente: 5 mg/m3 - ACGIH TLV
(fracción inhalable), 5 mg/m3 - OSHA PEL.

NOTA: Los límites y estándares se muestran únicamente como guía. Siga las regulaciones aplicables.

**CONTROLES DE INGENIERIA Y MEDIDAS OPERACIONALES APLICABLES**
...
_____________________________________________________________________________________________________________________ **Punto de ebullición / Rango:** - 316°C (600°F)
...
**Viscosidad:** 46 cSt (46 mm2/seg) a 40°C | 8.6 cSt (8.6 mm2/seg) a 100°C [ASTM D 445]
...
**Punto de fusión:** N/A
**Punto de Fluidez:** -39°C (-38°F)
**Extracto DMSO (solamente aceite mineral), IP-346:** < 3 %wt

**SECCIÓN 10** **ESTABILIDAD Y REACTIVIDAD**

**REACTIVIDAD:** Ver abajo sub-secciones.
...
|---|---|
|**Inhalación**|<br>|
|Toxicidad aguda: CL50: No hay datos<br>disponibles para este material.|Tóxico al mínimo. Basado en la evaluación de los componentes.|
|Irritación: No hay datos de punto final para el<br>material. <br>|Riesgo insignificante en la manipulación a temperaturas ambiente/<br>normal.|
|**Ingestión**|<br>|
|Toxicidad aguda: DL50: No hay datos<br>disponibles para este material. <br>|Tóxico al mínimo. Basado en la evaluación de los componentes.|
|**Piel**|<br>|
|Toxicidad aguda: DL50: No hay datos<br>disponibles para este material.|Tóxico al mínimo. Basado en la evaluación de los componentes.|
|Corrosión cutánea/Irritación: No hay datos<br>de punto final para el material. <br>|Irritación insignificante de la piel a temperatura ambiente. Basado<br>en la evaluación de los componentes.|
|**Ojo**||
...
|Lesiones oculares graves/Irritación: No hay<br>datos de punto final para el material.|Puede causar molestia ligera de poca duración a los ojos. Basado<br>en la evaluación de los componentes.|
|---|---|
|**Sensibilización**|<br>|
|Sensibilización respiratoria: Sin datos de<br>punto final para este material.|No se espera que sea sensibilizante respiratorio.|
|Sensibilización cutánea: Sin datos de punto<br>final para este material. <br>|No se espera que sea sensibilizante cutáneo. Basado en la<br>evaluación de los componentes.|
|**Aspiración:**Datos disponibles.|No se espera que constituya un peligro por aspiración. Datos<br>basados en las propiedades fisicoquímicas del material.|
|**Mutagenicidad en células germinales:**Sin<br>datos de punto final para este material.|No se espera que sea mutágeno en células germinales. Basado<br>en la evaluación de los componentes.|
|**Cancerigenicidad:**Sin datos de punto final<br>para este material.|No se espera que produzca cáncer. Basado en la evaluación de<br>los componentes.|
|**Toxicidad reproductiva:**Sin datos de<br>punto final para este material.|No se espera que sea tóxico para la reproducción. Basado en la<br>evaluación de los componentes. <br>|
|**Lactancia:**Sin datos de punto final para<br>este material.|No se espera que sea nocivo para los lactantes.|
|**Toxicidad en órganos diana específicos**<br>**(STOT)**||
|Exposición única: Sin datos de punto final<br>para este material.|No se espera que provoque daños en órganos tras una exposición<br>única.|
|Exposición repetida: Sin datos de punto final<br>para este material.|No se espera que provoque daños en órganos tras una exposición<br>prolongada o repetida. Basado en la evaluación de los<br>componentes.|
...
--LISTAS REGULADORAS INVESTIGADAS1 = NTP CARC 3 = IARC 1 5 = IARC 2B
...
_____________________________________________________________________________________________________________________ Componente de base lubricante -- Baja solubilidad, flota y se espera que migre del agua a la tierra. Se
...
**Listados o exentos de listado/notificación en los siguientes inventarios de productos químicos:** AIIC, ENCS,
ISHL, KECI, PICCS, TCSI, TSCA
**Casos especiales:**

|Inventario|Estado|
|---|---|
|IECSC <br>|Aplica restricciones <br>|
...
**No hay información adicional de seguridad aplicable a éste producto**
...
H400: Muy tóxico para los organismos acuáticos; Toxicidad aguda medio ambiente, Cat 1
H410: Muy tóxico para los organismos acuáticos, con efectos nocivos duraderos; Toxicidad crónica medio ambiente,
Cat 1

**ESTA HOJA DE SEGURIDAD CONTIENE LAS SIGUIENTES REVISIONES:**
Composición: Tabla de Componentes la información fue modificada.
Clasificación en Salud SGA la información fue borrada.
Peligros para la Salud SGA la información fue borrada.
Símbolo para la Salud SGA la información fue borrada.
Declaraciones de Precaución SGA - Disposición la información fue borrada.
Declaraciones de Precaución SGA - Prevención la información fue borrada.
Declaraciones de Precaución SGA - Respuesta la información fue borrada.
Declaraciones de Precaución SGA - Almacenamiento la información fue borrada.

Palabra Clave SGA la información fue borrada.
Identificación de los peligros: AP - Indicaciones de peligro - SGA La información fue adicionada.
Identificación de los peligros: AP - Indicaciones de peligro - SGA la información fue borrada.
Sección 02: Contenido SGA para códigos LABEL_GHS la información fue borrada.
Sección 04: Primeros Auxilios por Ingestión la información fue modificada.
Sección 04: Primeros Auxilios Inhalación la información fue modificada.

Sección 04: Primeros Auxilios en Piel la información fue modificada.

Sección 06: Medidas de Protección la información fue modificada.
Sección 07: Manejo y Almacenamiento - Manejo la información fue modificada.
...
_____________________________________________________________________________________________________________________ Sección 08: Tabla de Límites de Exposición la información fue modificada.
Sección 08: Protección para manos la información fue modificada.
Sección 08: Protección de Piel y Cuerpo la información fue modificada.
Sección 09: Color la información fue modificada.
Sección 09: Punto de Inflamación °C(°F) la información fue modificada.
Sección 09: Densidad Relativa la información fue modificada.

Sección 09: Viscosidad la información fue modificada.
Sección 11: Conclusión sobre Reproductividad la información fue modificada.
Sección 13: Consideraciones para desecho - Recomendacione spara desecho la información fue modificada.
Sección 14: TIERRA (DOT) - Predeterminado la información fue modificada.
Sección 15: Declaración de Peligros Chile la información fue modificada.
Sección 16: Código para EPP la información fue modificada.
Sección 16: Clave de HCode la información fue modificada.
Sección 16: MSN, MAT ID la información fue modificada.
