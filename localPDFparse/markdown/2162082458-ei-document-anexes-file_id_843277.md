---
title: INFORME DE MODELACIÓN DE DISPERSIÓN EMISIONES ATMOSFÉRICAS
author: IGNACIO GOIC
date: D:20240523112609-04'00'
language: es
type: report
pages: 23
has_toc: False
...
La siguiente tabla muestra los resultados obtenidos al hacer correr el modelo de dispersión de material
particulado en la zona de máximo impacto, como en el entorno cercano al proyecto.
...
<!-- Confianza de extracción: 1.00 -->
<!-- Contexto previo: -->
<!-- (MP10) y fino (MP2.5). La siguiente tabla muestra los resultados obtenidos al hacer correr el modelo de dispersión de material particulado en la zona de máximo impacto, como en el entorno cercano al proyecto. -->
