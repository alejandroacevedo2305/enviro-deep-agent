...
##### GAMA INDUSTRIAL INSONORIZADO ESTÁNDAR
...
#### Especificaciones Alternador | MECC ALTE
...
Largo (L) mm 2.100 2.100 2.100

Alto (H) mm 1.350 1.410 1.565

Ancho (W) mm 975 975 975

Volumen de embalaje máximo m3 2,76 2,89 3,2

Peso con líquidos en radiador Kg 990 1077 1128
y cárter

Capacidad del depósito L 100 190 330

Autonomía Horas 18 33 58

Nivel de presión sonora dB(A)@7m 67 ± 2,4 67 ± 2,4 67 ± 2,4
...
- Chasis estanco (hace función de doble
pared retención líquidos)

- Tapón drenaje depósito

- Tapón drenaje chasis

- Chasis predispuesto para instalación de kit
móvil
...
Software para PC `0` `0` `0`

Módem analógico `0` `0` `0`

Módem GSM/GPRS `0` `0` `0`

Pantalla remota `0`

Teleseñal `0 (8 + 4)`

J1939 `0 M7XJ` `0` `0 M7XJ`

Histórico de alarmas **•** [(100)] **•** **•** **•** (100)
(10) / (opc. +100) (10) / (opc. +100)
...
- Cuadro eléctrico de control y

potencia, con aparatos de
...
- Cargador de batería (incluido en

grupos con cuadro de versión
automática)

- Resistencia de caldeo (de serie

en grupos con cuadro de
versión automática)
